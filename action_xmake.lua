...
package("lsf")
    set_homepage("https://github.com/dayu521/lsf.git")
...
xpack("hcpp")
    ...
    add_installfiles("doc/cert/server.crt.pem",{prefixdir = "bin"})
    add_installfiles("doc/cert/server.key.pem",{prefixdir = "bin"})
    add_targets("hcpp")
