// HACK https://github.com/zozs/openssl-sign-by-ca/blob/master/openssl1.1/main.c
// 在c++中,goto语句与c中限制不同.修改了这些不同编译正常
...
//   FILE* caCertFile = fopen("tmp.pem", "wb");
//   if (!caCertFile) {
//     // EVP_PKEY_free(caKey);
//     X509_free(crt);
//     return false;
//   }
//   PEM_write_X509(caCertFile, crt);
//   fclose(caCertFile);
